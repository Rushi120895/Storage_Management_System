...
type PropType = {
  ...
  updatedWarehouse: NewWarehouseType,
  setUpdatedWarehouse: React.Dispatch<React.SetStateAction<NewWarehouseType>>,
  handleUpdateWarehouse: () => void
}

export default function UpdateWarehouseModal({ open, setOpen, updatedWarehouse, setUpdatedWarehouse, handleUpdateWarehouse}: PropType) {
                  ...
                  <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                    ...
                    <div className="mt-2 flex">
                      ...
                      <input
                        ...
                        value={updatedWarehouse.availableCapacity}
                        onChange={(e) => setUpdatedWarehouse({ ...updatedWarehouse, availableCapacity: e.target.value})}
                      />
                      </div>
                      <div>
                      <input
                        ...
                        value={updatedWarehouse.totalCapacity}
                        onChange={(e) => setUpdatedWarehouse({ ...updatedWarehouse, totalCapacity: e.target.value})}
                      />
                      </div>
